...
public class MeetingTimeService {
    ...
    /**
     * The method estimates the time interval which is comm for both zone
     *
     * @param currentDate
     *         the date in the zone 1
     * @param startTime1
     *         the start time of work in the zone 1
     * @param duration1
     *         the duration of work in zone 1
     * @param zoneId1
     *         the zone 1
     * @param currentDate2
     *         the date in the zone 2
     * @param startTime2
     *         the start time of work in the zone 2
     * @param duration2
     *         the duration of work in zone 2
     * @param zoneId2
     *         the zone 2
     * @return the duration of possible common time interval
     */

    public Duration intersectWorkingTime(LocalDate currentDate,
        ...
        ZonedDateTime end2today = start1.plus(duration2);
